            ...
            <div className={styles.mainContainer}>
                ...
                <div className={styles.mainText}>
                    ...
                    <TextInput
                        ...
                        size='lg'
                    />
                    <IconButton href='/account/change-email' className={styles.icon} label='Edit' kind='ghost' >
                ...
                <div className={styles.mainText}>
                    ...
                    <TextInput
                        ...
                        size='lg'
                    />
                    <IconButton href='/account/change-password' className={styles.icon} label='Edit' kind='ghost' >
